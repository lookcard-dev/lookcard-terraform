resource "aws_security_group" "account_api_sg" {
  ...
  ingress {
    ...
    security_groups = [var.sg_alb_id, var.reseller_api_sg, var.bastion_sg]
  }
  ...
  ingress {
    ...
    protocol    = "tcp"
    # cidr_blocks = ["0.0.0.0/0"]
    security_groups = [var.sg_alb_id, var.reseller_api_sg, var.bastion_sg] #var.reseller_api_sg
  }
...
resource "aws_security_group" "account_api_ecs_svc_sg" {
