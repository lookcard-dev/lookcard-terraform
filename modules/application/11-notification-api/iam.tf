    ...
    "Statement" : [
      {
        ...
        "Resource" : [data.aws_secretsmanager_secret.sentry.arn, data.aws_secretsmanager_secret.postmark.arn,data.aws_secretsmanager_secret.twilio.arn, data.aws_secretsmanager_secret.firebase.arn]
      }
    ]
  })
}
