terraform-backend-s3-init:
	aws s3api create-bucket --bucket lookcard-terraform-backend-development --region ap-southeast-1 --create-bucket-configuration LocationConstraint=ap-southeast-1
